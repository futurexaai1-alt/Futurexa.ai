// app/components/ui/cinematic-landing-hero.tsx
...
export function CinematicHero({
  ...
  cardDescription = (
    <>
      <span className="text-white font-semibold">Futurexa.ai</span> empowers
      businesses with dedicated squads across cloud, AI, security, and data —
      delivering outcome-driven results with clear milestones.
    </>
  ),
  metricValue = 500,
  ...
  ctaDescription =
    "Join hundreds of companies that trust Futurexa.ai to build, scale, and ship faster.",
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a
            href={ctaPrimaryHref}
            className="btn-modern-light flex items-center justify-center gap-3 px-10 py-4 rounded-[1.25rem] text-lg font-bold focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            {ctaPrimaryLabel}
          </a>
          <a
            href={ctaSecondaryHref}
            className="btn-modern-dark flex items-center justify-center gap-3 px-10 py-4 rounded-[1.25rem] text-lg font-bold focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background"
          >
            {ctaSecondaryLabel}
          </a>
        </div>
      ...
      >
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            {/* 2. MIDDLE (Mobile) / CENTER (Desktop): PHONE MOCKUP */}
            <div
            ...
            >
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">500+ Projects</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Successfully delivered</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">14 Years Experience</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">In digital innovation</p>
                  </div>
                </div>
