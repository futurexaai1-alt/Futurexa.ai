  ...
  return (
    <main className="bg-slate-900 min-h-screen text-white selection:bg-blue-500/30">
      ...
      <section className="py-32 px-6 relative overflow-hidden bg-slate-900">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-blue-500/5 rounded-full" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="group p-8 rounded-[2rem] bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.05] hover:border-white/[0.15] transition-[background-color,border-color] duration-200"
              >
      ...
      <section className="py-40 px-6 relative">
         <div className="max-w-[800px] mx-auto text-center">
            ...
            <Link to="/contact" className="inline-flex h-16 px-12 rounded-full bg-white text-slate-900 font-bold items-center gap-3 hover:bg-slate-200 transition-colors duration-200 shadow-sm uppercase tracking-widest text-sm">
              Forge Your Future
            </Link>
         </div>
      </section>
