/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2efbdf69dbb6c6900a56c2ce84cc457d)
// Runtime types generated with workerd@1.20260317.1 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		API_BASE_URL: string;
		API_BASE_URL: Fetcher /* futurexaaiapi */;
	}
	...
	interface Env {
		...
		SUPABASE_SERVICE_ROLE_KEY: string;
		SUPABASE_ANON_KEY: string;
		API_BASE_URL: string | Fetcher /* futurexaaiapi */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY" | "SUPABASE_ANON_KEY" | "API_BASE_URL">> {}
}
